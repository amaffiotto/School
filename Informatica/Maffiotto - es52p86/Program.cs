...
internal class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        int Sum = SumMatrixUnderDiagonal(matrice);
        Console.WriteLine($"Le somma degli elementi sotto la diagonale principale è: {Sum}");
    }

    private static int SumMatrixUnderDiagonal(int[,] matrice)
    {
        int result = 0;
