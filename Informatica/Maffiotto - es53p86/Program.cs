...
internal class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        int Sum = SumMatrixUnderSecondaryDiagonal(matrice);
        Console.WriteLine($"Le somma degli elementi sotto la diagonale secondaria è: {Sum}");
    }

    private static int SumMatrixUnderSecondaryDiagonal(int[,] matrice)
    {
        int result = 0;
