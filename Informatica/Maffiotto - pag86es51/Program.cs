...
internal class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        int[] coloumnSums = SumMatrixColums(matrice);
        Console.WriteLine("Le somme delle colonne sono:");
        for (int i = 0; i < coloumnSums.Length; i++)
        {
            Console.WriteLine($"Riga {i}: {coloumnSums[i]}");
        }
        
    }

    private static int[] SumMatrixColums(int[,] matrice)
    {
