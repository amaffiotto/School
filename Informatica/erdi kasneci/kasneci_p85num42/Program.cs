namespace Kasneci___kasneci_p85num42;
...
internal class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Matrice Caricata a spirale");
        LoadMatrixWithSpiral(matrice);
        StampaMatrice(matrice);
        
    }

    private static void LoadMatrixWithSpiral(int[,] matrice)
    {
